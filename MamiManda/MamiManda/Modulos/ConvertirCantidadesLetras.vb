Public Class ConvertirCantidadesLetras
    Public Function Letras(ByVal numero As String) As String
        ...
        If Val(numero) <= 999999999 Then
            ...
            If dec <> "" Then
                Letras = palabras & "Lempiras con " & dec & " centavos"
            Else
                Letras = palabras & "Lempiras exactos"
            End If

            Letras = Strings.Left(Letras, 1).ToUpper & Strings.Right(Letras, Letras.Length - 1)
        Else
            Letras = ""
        End If
    End Function
